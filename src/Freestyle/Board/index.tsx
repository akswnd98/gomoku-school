import freestyleBoardSvg from '@assets/images/freestyle-board.svg';
...
export default function Board () {
  ...
  useEffect(() => {
    ...
    const drawStarting = async () => {
      context.drawImage(await getImageFromUrl(freestyleBoardSvg), CANVAS_START_POS, CANVAS_START_POS);
  ...
  return (
    <Root>
      <canvas width={845} height={845} ref={canvasRef} onClick={handleClick}></canvas>
    </Root>
  );
}
